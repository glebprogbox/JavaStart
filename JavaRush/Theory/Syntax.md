## Start
Ява универсальный язык, программа запускается в ява машине. После компиляции ява сохраняет программу в байт коде, а ява машина этот код запускает.
...
i = 3;
x = i +1; (в итоге x = 4)
Можно сразу присваивать, int i = 3; int x = i +1;
